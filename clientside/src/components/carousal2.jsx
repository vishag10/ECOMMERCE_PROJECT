...
import carousel1 from "../assets/DALL·E 2025-03-12 20.28.38 - A modern and clean customer reviews section for a grocery website. The design includes a laptop-width layout with three customer review cards, each fe.png";
import carousel2 from "../assets/review1.jpeg";
import carousel3 from "../assets/DALL·E 2025-03-12 20.28.38 - A modern and clean customer reviews section for a grocery website. The design includes a laptop-width layout with three customer review cards, each fe.png";
import { ChevronLeft, ChevronRight } from 'lucide-react';

    const MainCarouselZero = React.memo(() => {
...
export default MainCarouselZero