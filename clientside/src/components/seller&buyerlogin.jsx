    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-gray-50 p-4">
            ...
            <div className="w-full max-w-6xl flex flex-col md:flex-row rounded-xl shadow-lg bg-white overflow-hidden">
                ...
                <motion.div
                    className="hidden md:block md:w-5/12 relative overflow-hidden min-h-[350px]"
                    ref={imageRef}
                ...
                >
                    ...
                    >
                        ...
                        >
                            The best investment you can make is in yourself. Start your journey today!
                        </motion.p>
                    </motion.div>
                </motion.div>

                <div className="w-full md:w-7/12 bg-white p-6 md:p-12">
                    <motion.div
                    ...
                    >
                        <div className="text-center mb-8">
                            ...
                            <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-2">Login</h2>
                        ...
                        <div className="text-center mt-4">
                            <p className="text-sm text-gray-600">
                                ...
                                <Link to="/signup" className="text-purple-800 hover:text-purple-700 font-medium ml-1">
